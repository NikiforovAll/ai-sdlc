...
- **Mint On Ink** (#7fd6a8): the green's legibility variant for accent text sitting on solid ink — the ① inside the inverted constraint strip, which is its only remaining site. Only ever appears on `ink`.
